...
function nv4_block_ctcat2( $block_config )
{
	...
	$xtpl = new XTemplate( 'global.ctcat2.tpl', NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks' );
...
{
	$content = nv4_block_ctcat2( $block_config );
}
